...
2. **Login page** (no numbered prompt yet)
   Introduce authentication and a user-scoped task model. Requires a domain decision on User/Student before implementation can start.
