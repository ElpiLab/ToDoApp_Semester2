...
- Prompt workflow: templates and archived prompts exist through `080-clarify-temporary-settings-controls`. Earlier UI work (Calendar page, Dashboard page, dialog redesign, sidebar cleanup) was iterative follow-up not driven by a numbered prompt.
