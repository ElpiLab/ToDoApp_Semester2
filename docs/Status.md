...
- Implementation state: the main pages are functional against SQLite:
  ...
  - **Settings page** - profile/preferences controls and a reset-data action.
- Prompt workflow: templates and archived prompts exist through `050-readme-contributions-and-export-scope`. Earlier UI work (Calendar page, Dashboard page, dialog redesign, sidebar cleanup) was iterative follow-up not driven by a numbered prompt.
