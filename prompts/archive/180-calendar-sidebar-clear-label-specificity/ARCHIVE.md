# Archive: 180 Calendar Sidebar Clear Label Specificity
...
- `docs/Changelog.md`
- `docs/Status.md`
- `prompts/archive/180-calendar-sidebar-clear-label-specificity/prompt.md`
- `prompts/archive/180-calendar-sidebar-clear-label-specificity/ARCHIVE.md`
